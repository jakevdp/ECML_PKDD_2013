...
In particular, we describe the \textit{estimator} interface shared by all
...
and developers of machine learning algorithms.
\end{abstract}
...
rather than a novel domain-specific programming language. From its core, the
library has been designed to tie in with the set of numeric and scientific
...
various areas (e.g., machine learning, natural language processing or
...
Because of this large base of developers, important efforts are demanded to make
...
machine learning challenges, or statistics from our repositories and mailing
lists.

\textcolor{red}{The rest of this text is organized as follows: in Section 2, ...}
