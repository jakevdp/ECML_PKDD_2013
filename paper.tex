...
such as SofiaML \citep{sculley2010web}
...
the users will find that they still need programming to process inputs/outputs,
...
that it is a \textit{general purpose} language, while still offering similar 
advantages to \textsc{matlab} and R through the use of NumPy and SciPy.
