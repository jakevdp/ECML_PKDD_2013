...
algorithms, model evalutation and selection tools, as well as
...
it exemplifies API design for scalable processing of ``big data''
which takes a different approach from the comparable models in \sklearn.
...
that follow the scikit-learn conventions. Examples of such packages include
...
algorithm \citep{mblondel-mlj2013}, released as
part of the
\textit{lightning}\footnote{\url{https://github.com/mblondel/lightning}}
package, also follows the scikit-learn conventions. To maximize ease of use, we
encourage more researchers to follow the scikit-learn conventions when
releasing their software in the future.
