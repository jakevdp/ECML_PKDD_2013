...
Initializing and fitting an estimator object proceeds in a way that is similar
to partial function application: an estimator can be considered as a function
that maps hyper-parameter settings to an actual learning algorithm. The
advantage of this API over one where the object initializer would perform the
learning will become especially apparent in Section~\ref{sec:advanced-api}.
