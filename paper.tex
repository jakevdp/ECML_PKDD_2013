...
or \textit{model selection} as it is called in the statistics literature.

The rest of this section explains some fundamental design choices
made throughout scikit-learn.
% TODO and the rest of the paper...
...
% Rewrite example using LinearSVC
...
While direct use of this idiom would not have any benefit
over using the individual stages of the sub-pipeline directly,
the recursion support shines when in more complex situations
...
% TODO insert example from http://stackoverflow.com/q/16437022/166749 here
