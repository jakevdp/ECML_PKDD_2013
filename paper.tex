...
depencies. As such, NumPy and SciPy -- the two most common dependencies in the
...
To ease code reuse, object-oriented techniques and design patterns are used all
throughout the codebase. In particular, the \textit{duck typing} design pattern
is widely exploited to simplify implementation and skip the introduction of
superfluous classes. This technique indeed allows both for extensibility and
