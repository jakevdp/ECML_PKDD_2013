...
between input variables $X_1, \ldots X_p$, called features, and
some output variable $Y$. A sample is then defined as a pair of
...
The focus of \sklearn to incorporate the entire process into a single package still
