...
potential solution to this problem would be for \sklearn to provide a Cython-
level API, thereby allowing the user to pass Cython-implemented kernel
functions.
...
The project is distributed under the simplified BSD license, encouraging
