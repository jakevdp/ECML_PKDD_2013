...
estimators may however also implement the \texttt{predict} interface.
...
to obtain cluster labels for unseen data \texttt{X\_test}.
...
\caption{Finding closest centroids for unseen data after $k$-means clustering.
         \texttt{clust\_pred} will hold integer indices of centroids.}
