...
\begin{abstract}
\sklearn is an increasingly popular machine learning library
for the Python programming language.
It is designed to be simple and efficient,
accessible to non-experts, and reusable in various contexts:
it has a user base in neuroscience, astronomy, computational linguistics,
as well as industry.
...
faced by users and developers of the library.\footnote{
  An earlier version of this paper was presented
  at the ECML/PKDD Workshop on Languages for Data Mining and Machine Learning,
  September 2013, Prague.}
\end{abstract}
...
such as SofiaML\footnote{\url{https://code.google.com/p/sofia-ml}}~\citep{sculley2009large}
