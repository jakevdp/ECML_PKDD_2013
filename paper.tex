...
The \texttt{predict} method in \textit{scikit-learn} thus offers a unified way
...
In \textit{scikit-learn}, the \texttt{fit} method always returns the estimator
...
\end{verbatim} 
In \textit{scikit-learn}, \texttt{fit(X\_train).transform(X\_train)} can further
...
In the same spirit, \textit{scikit-learn} sometimes provides the
