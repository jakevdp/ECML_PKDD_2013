...
believe that decoupling estimators from models is not worth the effort. The good
...
\sklearn by making estimators able to export a fitted model to an agnostic model
description such as PMML~\citep{guazzelli2009pmml}.
