...
\begin{description}
  ...
  \item[Inspection.]
       ...
       algorithms are stored as public attributes. All of them are documented in
       a consistent manner.
  ...
  \item[Non-proliferation of classes.]
       Only learning algorithms are objects of custom classes,
       Datasets and hyperparameter names and values
  ...
  % Gilles: this is actually not a design principle
  % \item[Composition.]
...
present in this section advanced API mechanisms for i) building meta-estimators,
ii) composing complex estimators and iii) selecting models.
