...
\affil[1]{ISLA, University of Amsterdam}
...
(among others, computer science, neuroscience, astrophysics). It also benefits
...
respect to some user-specified criterion. 
...
hyper-parameter settings for an support vector classifier (SVC)
...
an SVC with a linear kernel accepts a $\gamma$ parameter, but ignores it,
...
Some \sklearn estimators, among others the implementations of naïve Bayes
and minibatch $k$-means \citep{sculley2010web},
