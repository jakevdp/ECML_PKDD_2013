...
object-oriented sense) that users import into Python programs. Its use
therefore requires basic Python programming knowledge. No command-line
interface, let alone a GUI, is offered for non-programmer users. Instead,
...
of citations in scientific publications, successes in various machine learning challenges
...
\begin{description}
  \item[Inspectability.]
       ...
       are stored as public attributes. All of them are consistently documented.
  ...
  \item[Composition.]
       ...
       Also, some learning algorithms are naturally viewed
       ...
       for setting/retrieving parameters of sub-estimators.
...
regression algorithms can make predictions for single samples, most \sklearn
algorithms are intended to be used on batches of data. For efficiency reasons,
this indeed makes the use of NumPy and SciPy optimal by preventing the overhead
inherent to Python function calls and to per-element dynamic type checking.
% Gilles: I don't think it is worth mentionning online learning. They are exceptions in scikit-learn.
