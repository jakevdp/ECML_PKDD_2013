...
choices allowing for the easy usage and extension of \sklearn.
...
In particular,
they integrate within model selection routines, allowing one to optimize
every step of a complex workflow at once. Composition of estimators can be done in two
...
however neither is required to install or use \sklearn.
