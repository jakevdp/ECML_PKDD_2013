...
In machine learning, some algorithms are expressed as meta-algorithms built
and parametrized on simpler algorithms. Examples include ensemble methods which
...
in the sense that a union of transformers that map inputs having $d$ features
