...
The public API is oriented towards batch processing rather than online
processing. While classification and regression algorithms can indeed make
predictions for single samples, most \sklearn objects are however intended to be
used on batches of data. For efficiency reasons, this makes the use of NumPy and
SciPy optimal by preventing the overhead inherent to Python function calls or
due to per-element dynamic type checking.
