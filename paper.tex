...
SciPy \citep{vanderwalt2011, varoquaux2013scipy} libraries.
As such, \sklearn is intended to be used within Python scripts
and requires some Python programming knowledge.
At present, it offers no command line or graphical user interface.
...
to emphasize that \texttt{predict} generalizes to new data; however,
\texttt{predict} can also be called on \texttt{X\_train}). In the case of
